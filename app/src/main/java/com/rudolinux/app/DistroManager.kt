...
class DistroManager(private val context: Context) {
    ...
    val available = listOf(
        Distro(
            ...
            "~100–200 MB+", "Debian 12 userspace for ARM64 Android."
        ),
        Distro(
            "ubuntu2404", "Ubuntu", "24.04 LTS", "Noble", "arm64",
            "~30–100 MB+", "Ubuntu 24.04 LTS userspace for ARM64 Android."
        ),
        Distro(
            "ubuntu2204", "Ubuntu", "22.04 LTS", "Jammy", "arm64",
            "~30–100 MB+", "Ubuntu 22.04 LTS userspace for ARM64 Android."
        ),
        Distro(
            "alpine", "Alpine Linux", "3.24", "Alpine", "arm64",
            "~10–20 MB+", "Small Alpine Linux userspace from an official ARM64 Linux image."
        )
    )
