...
class DistroManagerActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val title = TextView(this).apply {
            text = "LinOx 0.5.2 — Distributions"
            textSize = 22f
    ...
    private fun render() {
        ...
        val note = TextView(this).apply {
            text = "RootFS images are pulled from public ARM64 OCI images. Docker Hub CDN redirects are handled safely, every layer is SHA-256 verified before extraction, and no root access is required."
            textSize = 12f
